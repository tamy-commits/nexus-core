...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "Central inteligente de prontidão documental — laboratório de cenários demonstrativos." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/23b1134e-e553-485c-aa8e-b6bcba089684/id-preview-7ae1c292--e3682aff-c21c-49b3-862e-d3bf2fd57929.lovable.app-1784768660055.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/23b1134e-e553-485c-aa8e-b6bcba089684/id-preview-7ae1c292--e3682aff-c21c-49b3-862e-d3bf2fd57929.lovable.app-1784768660055.png" },
    ],
    links: [

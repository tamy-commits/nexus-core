...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NEXUS — Central Inteligente de Prontidão Documental" },
      { name: "description", content: "Central inteligente de prontidão documental para operações corporativas." },
      { property: "og:title", content: "NEXUS — Central Inteligente de Prontidão Documental" },
      { property: "og:description", content: "Cenários demonstrativos, workspace de caso e comparação avaliada." },
